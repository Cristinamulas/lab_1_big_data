...
/usr/local/hadoop/bin/hdfs dfs -copyFromLocal ../lab_1_big_data/time_log/input/
/usr/local/hadoop/bin/hadoop jar /usr/local/hadoop/share/hadoop/tools/lib/hadoop-streaming-2.9.2.jar \
-file ../time_log/map_final.py -mapper ../lab_1_big_data/time_log/map_final.py \
-file ../time_log/time_reduce.py -reducer ../lab_1_big_data/time_log/time_reduce.py \
