...
/usr/local/hadoop/bin/hdfs dfs -copyFromLocal ../../lab_1_big_data/user_log/input/
/usr/local/hadoop/bin/hadoop jar /usr/local/hadoop/share/hadoop/tools/lib/hadoop-streaming-2.9.2.jar \
-file ../user_log/ma_f.py -mapper ../lab_1_big_data/user_log/map_f.py \
-file ../user_log/user_reduce.py -reducer ../lab_1_big_data/user_log/user_reduce.py \
